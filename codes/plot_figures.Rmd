...
```{r fig.width=4, fig.height=4}
ggboxplot(results,x ="class",y="raw.lfc.pds",fill="class",outlier.shape = "") + stat_compare_means()
```
...
```{r fig.width=4, fig.height=4}
ggscatterhist(results],x ="",y="deseq.lfc.pdc",size = 0.2, alpha=0.1,color="class",margin.params = list(fill="class",color="black",size=0.2))
```


```{r fig.width=4, fig.height=4}
ggboxplot(results,x ="class",y="raw.lfc.pdc",fill="class",outlier.shape = "") + coord_cartesian(ylim=c(-2,2))
```

```{r fig.width=4, fig.height=4}
ggdensity(results,x="raw.lfc.pds",fill="name",outlier.shape = "") + coord_cartesian(xlim=c(-2,2))
```

```{r fig.width=5, fig.height=5}
ggdensity(results,x="raw.lfc.pdc",fill="name",outlier.shape = "") + coord_cartesian(xlim=c(-2,2))
```

```{r fig.width=4, fig.height=4}
ggdensity(results,x="raw.lfc.pds",fill="class",outlier.shape = "") + coord_cartesian(xlim=c(-2,2))
```

```{r fig.width=4, fig.height=4}
ggdensity(results,x="raw.lfc.pdc",fill="class",outlier.shape = "") + coord_cartesian(xlim=c(-2,2))
```
