...
```
```{r fig.width=4, fig.height=3}
G4.motifs <- rtracklayer::import('../peaks/mm10_canonical_G4_PQS-regex.bed')
...
p3 <- plot_bw_profile(bwfiles = c('../mendeley/FigureS2/G4.mm10.plus.bw','../mendeley/FigureS2/G4.mm10.minus.bw'), loci = closG4, mode = "center",verbose = F, colors = c("#FFAAFF","#DDBBFF"),show_error = T)
...
```
```{r fig.width=8, fig.height=3}
p4 <- plot_bw_profile(bwfiles = geo_CnR_bigwigs[1:2], loci = "../peaks/mm10_canonical_G4_PQS-regex.bed", mode = "center",verbose = F, colors = mypal,show_error = T) + coord_cartesian(ylim=c(0,15))
p5 <- plot_bw_profile(bwfiles = geo_CnR_bigwigs[2], bg_bwfiles = geo_CnR_bigwigs[1], norm_mode = "log2fc", loci = "../peaks/mm10_canonical_G4_PQS-regex.bed", mode = "center",verbose = F, colors = mypal[2],show_error = T) + coord_cartesian(ylim=c(-2,2))
...
results$class <- factor(results$class, levels = c("CTCF_and_G4", "CTCF_not_G4"))
G4_bed <- import('../peaks/G4_WT_peaks.narrowPeak')
G4_bed$name <- "peak"
G4pred_bed <- import('../peaks/mm10_canonical_G4_PQS-regex.bed')
ATAC_bed <- import('../peaks/ATAC_seq_mESC_Martire_peaks.narrowPeak')
pro_bed <- import('../peaks/promoters_geneSymbol.mm10.bed')
